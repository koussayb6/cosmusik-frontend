...
import {reset, verify, logout} from "../features/auth/authSlice";
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12">
                                                ...
                                                <ul className="list-inline mb-4">
                                                    ...
                                                    <li onClick={activate2fa} className="list-inline-item d-block border-bottom me-0"><a href="#" className="pt-2 pb-2 d-flex align-items-center"><i className="btn-round-md bg-primary-gradiant text-white feather-anchor font-md me-3"></i> <h4 className="fw-600 font-xsss mb-0 mt-0">Activate two factor Authentication</h4><i className="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i></a></li>
